   ...
   const copyToClipboard = () => {
    ...
    return (
      ...
      <div className="card-tabs">
          <button className={activeTab === 1 ? "active" : ""} aria-label="HTML Page of Input Text Component" onClick={() => setActiveTab(1)}>
              HTML
          </button>
          <button className={activeTab === 0 ? "active" : ""} aria-label="CSS Page of Input Text Component" onClick={() => setActiveTab(0)}>
              CSS
          </button>
      </div>
