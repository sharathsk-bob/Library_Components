...
function BreakpointLayoutHtml(props) {
    const { BreakpointLayoutProps } = props;
    const sheet = new ServerStyleSheet();
    const html = ReactDOMServer.renderToStaticMarkup(sheet.collectStyles(<BreakpointLayout BreakpointLayoutProps= {BreakpointLayoutProps}/>));
...
export default BreakpointLayoutHtml